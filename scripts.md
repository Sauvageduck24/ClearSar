...
/usr/local/bin/python -m src.retinanet_train --project-root . --backbone resnet50 --epochs 80 --batch-size 32 --num-workers 16 --tile-size 512 --tiles True --lr 5e-4 --backbone-lr 1e-4 --trainable-layers 4
