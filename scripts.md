...
/usr/bin/python -m src.train --arch cascade_rcnn_swin_l --epochs 50 --batch-size 4 --num-workers 16 --image-size 512

/usr/bin/python -m src.train --arch cascade_rcnn_convnext_xl --epochs 50 --batch-size 4 --num-workers 16 --image-size 512
