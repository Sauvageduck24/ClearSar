...
sahi coco slice --dataset_json_path data/annotations/instances_train.json --image_dir data/images/train/ --output_dir data/sliced_dataset/ --slice_size 256 --overlap_ratio 0.25

sahi coco slice --dataset_json_path instances_train.json --image_dir data/images/test --output_dir data/sliced_test --slice_size 256 --overlap_ratio 0.25

## entrenamiento

& C:\Users\esteb\.conda\envs\clearsar\python.exe run_pipeline.py `
  --window-yolo `
...
/usr/bin/python -m src.train --arch cascade_rcnn_hrnet \
  ...
  --image-size 640 --save-top-k 1 --lr 3.5e-4
